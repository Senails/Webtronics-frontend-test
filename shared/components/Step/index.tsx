...
export function Step({direction,text,title,miniTitile}:props){
    return <div className={style.conteiner
        ...
        <div className={style.textBox}>
            ...
            <rect width="475" height="191" rx="8" fill="white" fillOpacity="0.05"/>
            <rect x="0.5" y="0.5" width="474" height="190" rx="7.5" stroke="url(#paint0_linear_2046_306)" strokeOpacity="0.7"/>
            <defs>
